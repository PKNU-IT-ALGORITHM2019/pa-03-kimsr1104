...
int Random_1000[1000];
int Random_10000[10000];
int Random_100000[MAX];
int Reverse_1000[1000];	
int Reverse_10000[10000];
int Reverse_100000[MAX];
int mer[MAX];				// 합병정렬시 추가배열
clock_t start, finish, timer = 0;	// 시간측정 변수

double TimeArr[7][6];			// 시간 출력 테이블
